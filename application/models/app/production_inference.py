...
class ProductionClassifier:
    def __init__(self, settings: Settings, model_dir: Path) -> None:
        ...
        self.factuality_artifact = joblib.load(model_dir / "factuality_semantic_visual_extra_trees.joblib")
        self.openrouter = (
    ...
    def _error_result(self, task: str, error: str) -> dict[str, Any]:
        return {"task": task, "label": None, "llm_label": None, "model": None, "error": error, "evidence": []}
